...
<head>
	...
	content="width=device-width,
			initial-scale=1.0"/>
	<link rel="stylesheet" href="buy.css" class="css" />
...
<div class="main">
    <a class="ba" id="countdown" >Payment Succesful.</a>
    <a class="ba" id="countdown" >Redirecting in 5 Seconds.</a>
    
    <progress value="0" max="12" id="progressBar"></progress>
    <?php 
